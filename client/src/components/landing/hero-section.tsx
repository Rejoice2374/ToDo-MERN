...
function BlurWord({ word, trigger }: { word: string; trigger: number }) {
  ...
  const DURATION = 900 // blur+opacity fade duration per letter
  const GRADIENT_HOLD = STAGGER * letters.length + DURATION + 2000
...
export function HeroSection() {
  ...
  return (
    <section className="relative flex min-h-screen flex-col items-start justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto w-full max-w-350 px-6 py-32 lg:px-12 lg:py-40">
        <div className="lg:max-w-[55%]">
          ...
          <div className="mb-12">
            <h1
              className={`font-display text-left text-[clamp(2rem,6vw,7rem)] leading-[0.92] tracking-tight text-white transition-all duration-1000 ${
                isVisible
                  ? "translate-y-0 opacity-100"
      ...
      <div
        className={`absolute right-0 bottom-12 left-0 px-6 transition-all delay-500 duration-700 lg:px-12 ${
