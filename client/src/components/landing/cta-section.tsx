...
export function CTASection() {
  return (
    <section className="relative flex w-full flex-col items-center justify-center overflow-visible px-5 pt-20 pb-10 md:pt-60 md:pb-20 lg:pt-60">
      ...
      <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center justify-start gap-9">
        <div className="flex flex-col items-center justify-start gap-4 text-center">
          <h2 className="max-w-108.75 text-4xl leading-tight font-semibold wrap-break-word text-foreground md:text-5xl md:leading-tight lg:text-[68px] lg:leading-19">
            Develop better Habits
          </h2>
          <p className="max-w-2xl text-sm leading-[18.20px] font-medium wrap-break-word text-muted-foreground md:text-base md:leading-relaxed">
            Take control of your productivity and achieve your goals with our
            powerful habit tracking app. Start building better habits today and
            unlock your full potential!
          </p>
        </div>
        <Link to="/auth?type=sign-up" rel="noopener noreferrer">
          <Button
            className="rounded-[99px] bg-secondary px-7.5 py-2 text-base leading-6 font-medium text-secondary-foreground shadow-[0px_0px_0px_4px_rgba(255,255,255,0.13)] transition-all duration-200 hover:bg-secondary/90"
            size="lg"
          >
            Signup for free
          </Button>
