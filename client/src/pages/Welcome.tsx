  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center bg-background">
      ...
      <div className="mt-6 flex gap-4">
        <button
          className="cursor-pointer rounded border-primary bg-primary px-4 py-2 hover:border-2 hover:bg-transparent"
          onClick={() => navigate("/auth?type=sign-up")}
        >
          Get Started
        </button>
        <button
          className="cursor-pointer rounded border-2 border-primary px-4 py-2 hover:bg-primary"
